...
pub fn get_productions() -> Productions {
    ...
    productions.push(vec![9, 53, 39, 54, 38, 55]);
    productions.push(vec![16]);
    productions.push(vec![16]);
    productions.push(vec![41, 9, 53]);
    ...
    productions.push(vec![58, 9, 59, 37, 50, 51, 52]);
    productions.push(vec![16]);
    productions.push(vec![13]);
    ...
    productions.push(vec![9]);
    productions.push(vec![8]);
    productions.push(vec![10]);
    productions.push(vec![16]);
    productions.push(vec![16]);
    productions.push(vec![44, 61, 43]);
    productions.push(vec![54, 9, 62]);
    productions.push(vec![38, 54, 9, 62]);
    productions.push(vec![16]);
    productions.push(vec![14, 63, 38, 64, 19]);
    productions.push(vec![16]);
    productions.push(vec![63, 38, 64]);
    productions.push(vec![9, 30, 65]);
    productions.push(vec![10, 30, 65]);
    productions.push(vec![8, 30, 65]);
    productions.push(vec![16]);
    productions.push(vec![25, 9, 66]);
    productions.push(vec![15, 44, 9, 69, 43, 37, 63, 38, 64, 36, 70]);
    productions.push(vec![1, 44, 9, 69, 43, 37, 63, 38, 64, 36]);
    productions.push(vec![17, 44, 9, 30, 71, 38, 9, 69, 38, 72, 43, 37, 69, 63, 38, 64, 36]);
    productions.push(vec![21, 37, 63, 38, 64, 36, 1, 44, 9, 69, 43]);
    productions.push(vec![23, 26, 9]);
    ...
    productions.push(vec![16]);
    productions.push(vec![32, 9, 74, 73]);
    productions.push(vec![16]);
    productions.push(vec![41, 9, 74]);
